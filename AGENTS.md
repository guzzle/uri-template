...
This file captures the repository conventions for `guzzlehttp/uri-template`. The
organization-wide
...
- `2.0` is the unreleased next major version and `1.0` is the current stable
...
[security policy](https://github.com/guzzle/uri-template/security/policy)
instead.
